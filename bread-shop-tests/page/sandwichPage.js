...
class SandwichPage {
    ...
    getTotalPrice() {
        //explicit wait until.elementLocated + 1000
        //fluent wait-> how ofend to run 
        return this.driver.wait(until.elementLocated(By.className('total-price')), 1000, "Total price was not located", 5).getText();
    }
